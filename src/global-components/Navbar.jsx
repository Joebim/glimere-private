...
export default function Navbar(props) {
  return (
    ...
    <div className="bg-transparent h-[80px] w-full absolute flex flex-row justify-between items-center px-[40px] sm:px-[80px] z-[1]">
        <div className="">
        <img src={glimere} alt="" className='w-[100px] hidden sm:block'/>
        ...
        <div className="">
            <div className='px-[35px] py-[5px] bg-[#ed7534] flex justify-center items-center text-white text-[15px] rounded-full cursor-pointer'
